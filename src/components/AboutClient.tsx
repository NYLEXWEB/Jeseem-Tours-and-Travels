...
const VALUES = [
  {
    icon: Compass,
    title: "Save on Airline Fares",
    desc: "We secure exclusive group flight tickets, special airline series fares, and negotiated hotel rates so you can travel affordably without compromising quality.",
  },
  {
    icon: Users,
    title: "Plan Custom Itineraries",
    desc: "Our travel specialists design bespoke itineraries for domestic and international holidays built around your schedule, budget, and personal preferences.",
  },
  {
    icon: ShieldCheck,
    title: "Global Visa & Document Care",
    desc: "We take care of fast-track tourist and business visa processing, MEA certificate attestation, and reliable emigration clearance support.",
  },
  {
    icon: BadgeCheck,
    title: "40+ Years of Travel Trust",
    desc: "Based in Alappuzha, Kerala since 1985, we bring four decades of professional airline coordinates and trusted customer service to every journey.",
  },
];
...
export default function AboutClient({ faqItems }: AboutClientProps) {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-24 items-center">
          <div>
            ...
            <ScrollReveal variant="fade-up" duration={0.8} delay={0.25}>
              <p className="text-[var(--foreground-muted)] text-base sm:text-lg font-light leading-relaxed mb-6 text-balance">
                Founded in {COMPANY_DETAILS.established} in Thiruvampady, Alappuzha, <strong>Jeseem Tours & Travels</strong> has been a trusted symbol of travel excellence across Kerala for four decades. Our core mission is summarized in our tagline: <b>Save - Plan - Go</b>.
              </p>
            </ScrollReveal>
            <ScrollReveal variant="fade-up" duration={0.8} delay={0.35}>
              <p className="text-[var(--foreground-muted)] text-sm sm:text-base font-light leading-relaxed mb-6">
                Whether you require group flight ticket bookings, custom holiday tour packages to Dubai, Maldives, Georgia, or Malaysia, document attestation, emigration support, or dedicated Hajj & Umrah pilgrimage arrangements, our highly experienced travel desks in Alappuzha process every request with complete reliability, speed, and 100% quality-ensured standards.
              </p>
            </ScrollReveal>
          </div>
        ...
        <div className="mb-24">
          <div className="text-center mb-12">
            ...
            <ScrollReveal variant="blur-in" duration={1.0} delay={0.15}>
              <h2 className="text-3xl md:text-5xl font-light tracking-tight text-[var(--foreground)]">
                Mission & Vision
              </h2>
            </ScrollReveal>
          </div>
              ...
              <div className="bg-[var(--card-bg)] border border-[#c4007b]/20 p-5 sm:p-8 md:p-10 rounded-3xl h-full flex flex-col justify-between shadow-sm hover:border-[#c4007b]/40 transition-colors">
                <div>
                  ...
                  <p className="text-[var(--foreground-muted)] text-sm md:text-base leading-relaxed font-light">
                    To deliver world-class, 100% quality-ensured travel solutions—from group flight ticket allocations and customized holiday packages to swift document attestations and visa clearances—empowering every client in Kerala with transparent pricing, utmost comfort, and peace of mind.
                  </p>
                </div>
            ...
            <ScrollReveal variant="fade-up" duration={0.8} delay={0.25}>
              <div className="bg-[var(--card-bg)] border border-sky-500/20 p-5 sm:p-8 md:p-10 rounded-3xl h-full flex flex-col justify-between shadow-sm hover:border-sky-500/40 transition-colors">
                <div>
                  ...
                  <p className="text-[var(--foreground-muted)] text-sm md:text-base leading-relaxed font-light">
                    To be recognized as the premier travel consultancy in Kerala and globally, celebrated for unyielding integrity, zero-compromise quality standards, zero hidden costs, and nurturing lifelong relationships with every traveler we serve.
                  </p>
                </div>
            ...
            <div className="bg-brand-gradient-light border border-brand-gradient-light p-5 sm:p-8 md:p-12 rounded-3xl shadow-md relative overflow-hidden">
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 relative z-10">
                ...
                <div className="shrink-0">
                  <Link
                    href="/contact"
                    className="px-8 py-4 rounded-full bg-brand-gradient-btn font-bold text-xs uppercase tracking-wider shadow-md inline-flex items-center gap-2 hover:scale-105 transition-transform"
                  >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
              ...
              <div className="lg:col-span-4 flex justify-center">
                <div className="relative w-48 h-64 md:w-56 md:h-72 rounded-2xl overflow-hidden border-2 border-[#c4007b]/50 shadow-xl group bg-purple-50">
                  ...
                  <div className="absolute bottom-3 left-3 right-3 text-center">
                    <span className="text-[10px] uppercase tracking-widest text-white bg-brand-gradient font-bold px-3 py-1 rounded-full shadow-md inline-block">
                      FOUNDER
                    </span>
                  </div>
                </div>
              ...
              <div className="lg:col-span-8 space-y-4 text-left">
                ...
                >
                  ...
                  <span className="text-sm font-bold text-[#c4007b] block sm:inline sm:ml-2">
                    ( late in 2022 )
                  </span>
                </motion.h2>
                ...
                <ScrollReveal variant="fade-up" duration={0.8} delay={0.2}>
                  <p className="text-zinc-700 text-base font-light leading-relaxed">
                    Jeseem Tours & Travels was established in 1985 under the visionary leadership of <strong>Late KUNJUMON ISMAIL</strong>. For 37 dedication-filled years—from 1985 until his passing in late 2022—he personally nurtured the agency with unwavering honesty, warm hospitality, and deep commitment to every traveler in Alappuzha and throughout Kerala.
                  </p>
                </ScrollReveal>

                <ScrollReveal variant="fade-up" duration={0.8} delay={0.3}>
                  <p className="text-zinc-600 text-sm font-light leading-relaxed">
                    Today, his family and dedicated team carry forward his enduring legacy with the same values of trust, honesty, and individualized traveler care that he championed from day one.
                  </p>
                </ScrollReveal>

                <div className="pt-2 flex items-center gap-3">
                  <div className="w-8 h-[1px] bg-[#c4007b]/50" />
                  <span className="text-xs text-[#c4007b] font-mono font-semibold italic">
                    40+ Years of Trusted Foundation
                  </span>
                </div>
              </div>
            </div>
        ...
        <div className="border-t border-[var(--border)] pt-20 mb-24">
          <div className="text-center mb-16">
            <ScrollReveal variant="fade-up" duration={0.8}>
              <span className="text-xs uppercase tracking-widest text-[#ff007f] font-bold block mb-2">
                OUR STANDARDS & VALUES
              </span>
            </ScrollReveal>
            <ScrollReveal variant="blur-in" duration={1.0} delay={0.15}>
              <h2 className="text-3xl md:text-4xl font-light tracking-tight text-white">
                The Core Pillars of Our Travel Agency
              </h2>
            </ScrollReveal>
          </div>
            ...
            {VALUES.map((val) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-[var(--foreground-muted)] text-xs leading-relaxed font-light">
                    {val.desc}
                  </p>
                </ScrollReveal>
              );
        ...
        <FaqAccordion
          ...
          subtitle="Answers to common questions about our agency history, accreditation, document processing, and customer support in Alappuzha, Kerala."
        ...
        <div className="relative rounded-3xl overflow-hidden h-[300px] flex items-center justify-center text-center p-6 border border-[var(--border)] mt-12">
          ...
          <div className="relative z-20 max-w-2xl">
            <ScrollReveal variant="fade-up" duration={0.8}>
              <h3 className="text-2xl md:text-3xl font-light tracking-tight text-neutral-50 mb-4">
            ...
            <ScrollReveal variant="fade-up" duration={0.8} delay={0.15}>
              <p className="text-sm text-neutral-300 font-light leading-relaxed mb-6">
                Our dedicated flight booking, visa assistance, and holiday tour coordinators in Alappuzha are ready to help you plan your next trip. Get in touch today.
              </p>
            </ScrollReveal>
            <ScrollReveal
              variant="fade-up"
            ...
            >
              <Magnetic range={30} strength={0.3}>
                <Link
                  href="/contact"
                  className="inline-block px-8 py-3.5 rounded-full bg-brand-gradient-btn text-white font-bold text-xs uppercase tracking-wider shadow-lg hover:scale-105 transition-transform"
                >
                  Contact Our Travel Desks
                </Link>
              </Magnetic>
            </ScrollReveal>
          </div>
