...
const PACKAGES = [
  {
    ...
    highlights: [
      ...
      "Special and Series airline fares on major carriers",
      "Instant confirmation & advance seat blocks",
      "Emigration clearance & terminal transfer support",
    ],
  },
  {
    id: "domestic-kerala",
    ...
    highlights: [
      ...
      "Munnar tea plantation guided estate walks & mountain views",
      "Chauffeur-driven private luxury AC sedan / SUV",
      "Traditional Ayurvedic spa & beach resort stays",
    ],
  },
  {
    id: "international-dubai",
    title: "Dubai & Abu Dhabi Desert Safari Package",
    ...
    highlights: [
      ...
      "Desert safari with private 4x4 dune bashing & BBQ camp",
      "Private city transfers, Marina cruise & English/Malayalam guides",
      "Fast-tracked UAE tourist visa processing",
    ],
  },
  {
    id: "visa-assistance",
    title: "Global Visa & Certificate Attestation Desk",
    ...
    highlights: [
      ...
      "HRD, MEA, Apostille & Embassy Certificate Attestation",
      "Emigration clearance coordination & POE assistance",
      "All major global destinations (UAE, Schengen, UK, USA, Asia)",
    ],
  },
  {
    id: "umrah-pilgrimage",
    title: "Hajj & Umrah Pilgrimage Tour Packages",
    ...
    highlights: [
      ...
      "Guided Ziyarat tour with experienced multilingual religious guides",
      "Flight ticket booking & dedicated pilgrimage visa desk",
      "24/7 localized support team coordination throughout the pilgrimage",
    ],
  },
];
...
export default function PackagesClient({ faqItems }: PackagesClientProps) {
    ...
    <div className="bg-[var(--background)] pt-32 pb-20 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-16">
          ...
          <ScrollReveal variant="fade-up" duration={0.8} delay={0.3}>
            <p className="text-[#86868B] text-base sm:text-lg max-w-2xl font-light leading-relaxed">
              Custom travel formulas crafted by our senior travel designers in Alappuzha, complete with competitive flight fares, luxury lodgings, visa support, and hand-selected outings.
            </p>
          </ScrollReveal>
        </div>
        ...
        <FaqAccordion
          ...
          subtitle="Answers to common questions regarding tour inclusions, payment methods, cancellation terms, and custom package bookings from Kerala."
          badge="PACKAGE BOOKING GUIDE"
          className="mt-24"
        />
      </div>
    </div>
